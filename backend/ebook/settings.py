...
MIDDLEWARE = [
    ...
    'ebook.middleware.rate_limit.RateLimitMiddleware',
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv("DB_NAME", "ebook_db"),
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "mamijohn1997@gmail.com")
...
VERY_OVERDUE_DAYS = int(os.getenv("VERY_OVERDUE_DAYS", "14"))
